  ...
  const grouped = useMemo(() => {
    ...
    for (const e of schedule) {
      ...
      const filteredAssignments = e.assignments.filter((a) => {
        ...
        if (slot?.subjectName.toLowerCase().includes(q) || slot?.subjectCode.toLowerCase().includes(q)) return true;
